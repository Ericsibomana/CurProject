...
<footer class="bg-custom-navy text-white pt-10 pb-6">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="<?php echo $web_root; ?>index.php" class="text-gray-300 hover:text-white transition-colors">Home</a></li>
                    <li><a href="<?php echo $web_root; ?>pages/about.php" class="text-gray-300 hover:text-white transition-colors">About</a></li>
                    <li><a href="<?php echo $web_root; ?>pages/courses.php" class="text-gray-300 hover:text-white transition-colors">Courses</a></li>
                    <li><a href="<?php echo $web_root; ?>pages/incubator.php" class="text-gray-300 hover:text-white transition-colors">Incubator</a></li>
                    <li><a href="<?php echo $web_root; ?>pages/all-news.php" class="text-gray-300 hover:text-white transition-colors">News</a></li>
                    <li><a href="<?php echo $web_root; ?>pages/contact.php" class="text-gray-300 hover:text-white transition-colors">Contact</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-300">Huye Campus, Butare<br>Rwanda</span>
                    </li>
                    <li class="flex items-center">
                        ...
                        <span class="text-gray-300">+250 78 123 4567</span>
                    </li>
                    <li class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                        <span class="text-gray-300">entrepreneurship@cur.ac.rw</span>
                    </li>
                </ul>
            </div>
        ...
        <div class="border-t border-blue-800 pt-6">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 text-sm mb-4 md:mb-0">
                    &copy; <?php echo date('Y'); ?> Catholic University of Rwanda. Center for Entrepreneurship. All rights reserved.
                </p>
